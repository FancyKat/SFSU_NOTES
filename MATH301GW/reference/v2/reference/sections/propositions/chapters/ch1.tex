    ...
    \item $(m-n)+(p-q)=(m+p)-(n+q)$
          \begin{proof}
              ...
              \begin{align*}
                  ...
                  %By the definition of subtraction, $m-n=m+(-n)$ and $p-q=p+(-q)$.
                              & = (m+(p+(-q)))+(-n) &  & \text{(Axiom 1.1(ii))}             \\
                  %We use the associativity of addition to rearrange the terms.
                              & = ((m+p)+(-q))+(-n) &  & \text{(Axiom 1.1(ii))}             \\
                  %We use the associativity of addition again to rearrange the terms.
                              & = (m+p)+((-q)+(-n)) &  & \text{(Axiom 1.1(ii))}             \\
                  %We use the commutativity of addition to swap $(-q)$ and $(-n)$.
                              & = (m+p)+((-n)+(-q)) &  & \text{(Axiom 1.1(i))}              \\
                  %Since $-n$ and $-q$ are the additive inverses of $n$ and $q$ respectively, $(-n)+(-q)=-(n+q)$.
    ...
    \item $(m-n)-(p-q)=(m+q)-(n+p)$
          \begin{proof}
              ...
              \begin{align*}
                  ...
                  %We distribute $-1$ to both $p$ and $(-q)$.
                              & = (m+(-n))+(-p+q)       &  & \text{(Axiom 1.1(iii))}            \\
                  %We use the associativity of addition to rearrange the terms.
                              & = (m+(-p+q))+(-n)       &  & \text{(Axiom 1.1(ii))}             \\
                  %We use the associativity of addition again to rearrange the terms.
                              & = ((m+q)+(-p))+(-n)     &  & \text{(Axiom 1.1(ii))}             \\
                  %We use the commutativity of addition to swap $(-p)$ and $(-n)$.
                              & = ((m+q)+(-n))+(-p)     &  & \text{(Axiom 1.1(i))}              \\
                  %We use the associativity of addition to rearrange the terms.
                              & = (m+q)+((-n)+(-p))     &  & \text{(Axiom 1.1(ii))}             \\
                  %Since $-n$ and $-p$ are the additive inverses of $n$ and $p$ respectively, $(-n)+(-p)=-(n+p)$.
    ...
    \item $(m-n)(p-q)=(mp+nq)-(mq+np)$
          \begin{proof}
              ...
              \begin{align*}
                  (m-n)(p-q) & = (m+(-n))(p+(-q))        &  & \text{(definition of subtraction)} \\
                  %By the definition of subtraction, $m-n=m+(-n)$ and $p-q=p+(-q)$.
                             & = mp+m(-q)+(-n)p+(-n)(-q) &  & \text{(Axiom 1.1(iii))}            \\
                  %We distribute $m$ and $(-n)$ to both terms in the second parentheses.
                             & = mp+(-mq)+(-np)+nq       &  & \text{(Axiom 1.1(iii))}            \\
                  %We distribute $-1$ to both $mq$ and $np$.
                             & = (mp+nq)+((-mq)+(-np))   &  & \text{(Axiom 1.1(ii))}             \\
                  %We use the associativity of addition to rearrange the terms.
                             & = (mp+nq)-(mq+np)         &  & \text{(definition of subtraction)}
              \end{align*}
              Therefore, $(m-n)(p-q)=(mp+nq)-(mq+np)$ for all $m,n,p,q \in \mathbb{Z}$.
          \end{proof}
    \item $m-n=p-q$ if and only if $m+q=n+p$
          \begin{proof}
              Let $m,n,p,q \in \mathbb{Z}$.
              ...
              \begin{align*}
                  ...
                  %By the additive inverse property, $(-q)+q=0$.
                  m+((-n)+q)     & = p+0        &  & \text{(Axiom 1.4)}                 \\
                  %By the additive identity property, $p+0=p$.
                  ...
                  %By the additive inverse property, $(-n)+n=0$.
                  (m+q)+0        & = p+n        &  & \text{(Axiom 1.4)}                 \\
                  %By the additive identity property, $(m+q)+0=m+q$.
              ...
              \begin{align*}
                  ...
                  %By the additive identity property, $m+0=m$.
                  ...
                  %By the additive identity property, $0+(p+(-q))=p+(-q)$.
                  m+(-n)     & = p+(-q)            &  & \text{(Axiom 1.2)}                 \\
                  %By the definition of subtraction, $m+(-n)=m-n$ and $p+(-q)=p-q$.
                  m-n        & = p-q               &  & \text{(definition of subtraction)}
              \end{align*}
    ...
    \item $(m-n)p=mp-np$
          \begin{proof}
              ...
              \begin{align*}
                  ...
                  %By the definition of subtraction, $m-n=m+(-n)$.
                         & = mp+(-n)p  &  & \text{(Axiom 1.1(iii))}            \\
                  %We distribute $p$ to both $m$ and $(-n)$.
                         & = mp+(-np)  &  & \text{(Axiom 1.1(iii))}            \\
                  %We distribute $-1$ to $np$.
